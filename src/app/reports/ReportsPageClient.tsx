          ...
          >
            <div className="p-4 space-y-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="app-shell-kicker text-[11px] uppercase tracking-[0.26em]">Reports</p>
                  <h1 className="app-shell-title text-lg font-semibold">Daily Reports</h1>
                </div>
              </div>
              <div className="space-y-1">
                ...
                <button
                  ...
                  data-active={viewMode === 'in_review'}
                  className="app-shell-link flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all"
                >
