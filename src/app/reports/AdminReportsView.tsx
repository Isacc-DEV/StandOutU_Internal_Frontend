            ...
            {viewMode === 'dashboard' ? (
              <>
                <section className="grid gap-5 md:grid-cols-4">
                  <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50/50 px-6 py-5 shadow-sm transition-all duration-300 hover:border-red-200 hover:shadow-md">
